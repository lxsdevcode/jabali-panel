                    ...
                    Placeholder::make('brandingActions')
                        ...
                        ->content(new HtmlString(
                            (($this->currentLogo || $this->currentLogoDark)
                                ? '<button type="button" wire:click="removeLogo" class="fi-btn fi-btn-size-md fi-btn-color-danger inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-semibold text-white bg-danger-600 hover:bg-danger-500">'
                                ...
                                : '')
                            .'<button type="button" wire:click="saveBranding" class="fi-btn fi-btn-size-md fi-btn-color-primary inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-semibold text-white bg-primary-600 hover:bg-primary-500">'
