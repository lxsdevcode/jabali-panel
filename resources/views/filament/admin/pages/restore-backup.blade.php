                        ...
                        <div class="ml-8 space-y-3">
                            <div class="flex gap-4">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" wire:model.live="filesRestoreMode" value="domains" class="fi-radio-input text-primary-600">
                                    {{ __('Full Domains') }}
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" wire:model.live="filesRestoreMode" value="files" class="fi-radio-input text-primary-600">
